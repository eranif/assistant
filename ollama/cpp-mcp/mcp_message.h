...
struct request {
  ...
  // Create a request
  static request create(const std::string& method,
  ...
  static request create_with_id(const json& id, const std::string& method,
                                const json& params = json::object()) {
    request req;
    req.jsonrpc = "2.0";
    req.id = id;
  ...
  static request create_notification(const std::string& method,
                                     const json& params = json::object()) {
    request req;
    req.jsonrpc = "2.0";
    req.id = nullptr;
...
struct response {
  ...
  static response create_success(const json& req_id,
                                 const json& result_data = json::object()) {
    response res;
    res.jsonrpc = "2.0";
    res.id = req_id;
  ...
  static response create_error(const json& req_id, error_code code,
